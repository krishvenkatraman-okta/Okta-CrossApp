...
export const OKTA_CONFIG = {
  ...
  clientId: process.env.OKTA_CLIENT_ID || "0oa8uywkjcduK9wG30g7",
  orgDomain: process.env.OKTA_ORG_DOMAIN || "https://qa-aiagentsproduct2tc1.trexcloud.com",
  orgAuthorizationEndpoint: `${process.env.OKTA_ORG_DOMAIN || "https://qa-aiagentsproduct2tc1.trexcloud.com"}/oauth2/v1/authorize`,
  authServerIssuer:
    process.env.OKTA_AUTH_SERVER_ISSUER || "https://qa-aiagentsproduct2tc1.trexcloud.com/oauth2/aus8uyrhdz9VliiSG0g7",
  clientSecret: process.env.OKTA_CLIENT_SECRET || "kynuDVOz8uJiN50KC8mVG5Fs4MLi3CF0ePPPLAYueihTXKcuAzDLjPTYllPOEkU7",
  agentPrincipalId: process.env.OKTA_AGENT_PRINCIPAL_ID || "wlp8uz04u5JEBjmHf0g7",
  ...
  // Private Key JWT for client authentication - use environment variable
  privateKeyJWT: process.env.OKTA_PRIVATE_KEY_JWK
    ? JSON.parse(process.env.OKTA_PRIVATE_KEY_JWK)
    : {
        alg: "RS256",
        ...
        kid: process.env.OKTA_KEY_ID || "2e4ab4cb554d2fc1a2d73478b95c936a",
        use: "sig",
      },
} as const
